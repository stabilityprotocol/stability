...
///
/// ```rust
/// stability_sp_tracing::enter_span!(stability_sp_tracing::Level::TRACE, "fn wide span");
/// {
/// 		stability_sp_tracing::enter_span!(stability_sp_tracing::trace_span!("outer-span"));
/// 		{
/// 			stability_sp_tracing::enter_span!(stability_sp_tracing::Level::TRACE, "inner-span");
/// 			// ..
/// 		}  // inner span exists here
/// 	} // outer span exists here
///
/// stability_sp_tracing::within_span! {
/// 		stability_sp_tracing::debug_span!("debug-span", you_can_pass="any params");
///     1 + 1;
...
/// use any valid `stability_sp_tracing::Span`followe by `;` and the code to execute,
///
/// # Example
///
/// ```
/// stability_sp_tracing::within_span! {
///     stability_sp_tracing::Level::TRACE,
///     "test-span";
///     1 + 1;
///     // some other complex code
/// }
///
/// stability_sp_tracing::within_span! {
///     stability_sp_tracing::span!(stability_sp_tracing::Level::WARN, "warn-span", you_can_pass="any params");
///     1 + 1;
///     // some other complex code
/// }
///
...
/// or pass in any valid `stability_sp_tracing::Span` for extended usage. The span will
...
///
/// ```
/// stability_sp_tracing::enter_span!(stability_sp_tracing::Level::TRACE, "test-span");
/// // previous will be dropped here
/// stability_sp_tracing::enter_span!(
/// 	stability_sp_tracing::span!(stability_sp_tracing::Level::DEBUG, "debug-span", params="value"));
/// stability_sp_tracing::enter_span!(stability_sp_tracing::info_span!("info-span",  params="value"));
///
/// {
/// 		stability_sp_tracing::enter_span!(stability_sp_tracing::Level::TRACE, "outer-span");
/// 		{
/// 			stability_sp_tracing::enter_span!(stability_sp_tracing::Level::TRACE, "inner-span");
/// 			// ..
/// 		}  // inner span exists here
