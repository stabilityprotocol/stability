...
use sp_core::{
	bytes::from_hex, crypto::Ss58Codec, sr25519, storage::Storage, Pair, Public, H160, U256,
};
	...
	GenesisConfig {
		...
		evm: EVMConfig {
			accounts: {
				...
				map.insert(H160::from_str("0xa8D14fBfCe59C42037F39a3ed2417CEe5Abfc4a5").expect("invalid address"), fp_evm::GenesisAccount {
					nonce: Default::default(),
					balance: Default::default(),
					storage: Default::default(),
